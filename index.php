...
<html>
<head>
<title>-HASAN HÜSEYİN TABANSIZ-</title>
<meta charset="utf-8">
...
?>
      ...
      <figure id="slide-2"><a class="view" href="#"><img src="images/demo/slider/1.jpg" alt=""></a>
        <figcaption>
          <h2>uygulama2</h2>
<?php
...
// Örnek kullanım
$data = array(
    array('Sanal Kart Numarası' => '1111 1111 1111 0000', 'Son Kullanim Tarihi' => '09/27', 'CVV' => '2363'),
...
echo createTable($data);
  ?>
      ...
      <figure id="slide-3"><a class="view" href="#"><img src="images/demo/slider/1.jpg" alt=""></a>
        <figcaption>
          <h2>uygulama3</h2>
         <?php
 ...
 {
  echo "<table width=400 height=150 border=1>";
...
?>
      ...
      <figure id="slide-4"><a class="view" href="#"><img src="images/demo/slider/1.jpg" alt=""></a>
        <figcaption>
          <h2>UYGULAMA4</h2>
          <?php 
 $turkLirasi=3000;
...
?>
      ...
      <figure id="slide-5"><a class="view" href="#"><img src="images/demo/slider/1.jpg" alt=""></a>
        <figcaption>
